...
const STATUS_ORDER = ["CHECKED_IN", "IN_PROGRESS", "SCHEDULED", "COMPLETED"] as const;
                        ...
                        >
                          <div className="min-w-0">
                            ...
                            <p className="text-sm text-muted-foreground">
                              {format(new Date(appt.scheduledAt), "h:mm a")} · {appt.patient.mrn}
                          ...
                          <div className="flex shrink-0 flex-wrap gap-2">
                            ...
                            {canComplete &&
                            ["SCHEDULED", "CHECKED_IN", "IN_PROGRESS"].includes(appt.status) ? (
                              <Button
                                type="button"
                                size="lg"
                                variant="secondary"
